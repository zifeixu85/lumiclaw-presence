...
const matrix={
  ...
  governanceAndTamper:requireMatches([/Owner NO_OVERLAY/u,/controlled A5 fixture/u,/invalidates audit, decision and package lineage/u,/deterministic binary ZIP and rejects digest mismatches/u]),
