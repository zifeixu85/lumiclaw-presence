...
try {
  ...
  for (const [table, assignment] of [['governed_artifact_revisions', 'revision=99'], ['audit_decisions', "status='MUTATED'"], ['trace_events', "kind='MUTATED'"], ['ledger_entries', 'sequence=999'], ['shadow_idempotency', "response_etag='MUTATED'"]] as const) {
