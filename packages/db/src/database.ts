...
export type LocalOnboardingSessionsTable = {owner_profile_id: string; schema_version: 1; path: 'UNSELECTED' | 'PUBLIC_SAFE_EXAMPLE' | 'LOCAL_MATERIALS'; state: 'MATERIAL_CHOICE' | 'MATERIALS_READY' | 'CONTEXT_READY' | 'COMPLETED'; data_mode: 'LOCAL_PRIVATE' | 'PUBLIC_SAFE_EXAMPLE'; organization_id: string | null; campaign_id: string | null; market_code: string | null; content_locale: string | null; platform: string | null; time_zone: string | null; market_codes: Json; content_locales: Json; platforms: Json; default_time_zone: string | null; material_ids: Json; created_at: Timestamp; updated_at: Timestamp};
