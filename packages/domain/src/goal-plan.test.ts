...
import {GoalPlanContractError,createOperatingGoalRevision,expectedPlanDates,validateLocalDate,validateOperatingGoalInput} from './goal-plan.js';
...
describe('SDD-009 Goal/Plan closed schemas',()=>{
  ...
  it('round-trips exact calendar dates including leap years',()=>{
    expect(validateLocalDate('2028-02-29')).toBe('2028-02-29');
    expect(validateOperatingGoalInput({...base,startsAt:'2028-02-29',endsAt:'2028-03-06'}).startsAt).toBe('2028-02-29');
    for(const date of ['2026-02-30','2025-02-29'])expect(()=>validateLocalDate(date)).toThrowError(expect.objectContaining({code:'LOCAL_DATE_INVALID'}));
  });
  ...
  it.each([
    ...
    [{...base,startsAt:'2026-02-30',endsAt:'2026-03-08'},'GOAL_TIME_WINDOW_INVALID'],
    [{...base,startsAt:'2025-02-29',endsAt:'2025-03-07'},'GOAL_TIME_WINDOW_INVALID'],
