...
export type ValidationIssue = {
  code:
    ...
    | 'SCHEDULE_SOURCE_REVISION_STALE'
    | 'SCHEDULE_OCCURRENCE_SCOPE_INVALID'
    | 'MISSION_SOURCE_DIGEST_MISMATCH'
  | 'ACTION_GRANT_SCOPE_INVALID'
  | 'ACTION_GRANT_DIGEST_MISMATCH'
  | 'ACTION_GRANT_EXPIRED'
  | 'ACTION_GRANT_REVOKED'
  | 'ACTION_GRANT_ALREADY_CONSUMED'
  | 'ACTION_GRANT_OCCURRENCE_NOT_FOUND'
  | 'ACTION_GRANT_REVISION_NOT_FOUND'
  | 'ACTION_GRANT_CHANNEL_ACCOUNT_NOT_FOUND'
  | 'ACTION_GRANT_CAPABILITY_NOT_FOUND'
  | 'ACTION_GRANT_CAPABILITY_PLATFORM_MISMATCH'
  | 'ACTION_GRANT_CAPABILITY_ACCOUNT_MISMATCH'
  | 'ACTION_GRANT_SIGNATURE_INVALID'
  | 'ACTION_GRANT_KEY_ID_MISMATCH'
  | 'ACTION_GRANT_OCCURRENCE_SCOPE_INVALID'
  | 'ACTION_GRANT_ACTIVATION_UNIT_NOT_FOUND'
  | 'ACTION_GRANT_EXECUTION_MODE_MISMATCH'
  | 'OUTBOX_CONSUMER_LOCKED';
  path: string;
  message: string;
};
