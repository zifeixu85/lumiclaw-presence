import type {LocalOnboardingContext, ManualPublishHandoff} from '@lumiclaw/domain';
...
export async function completeLocalOnboarding(): Promise<void> { await requestJson('/api/v1/local-onboarding/complete', {method: 'POST'}); }
