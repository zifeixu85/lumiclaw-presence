...
const copy = {
  ...
  en: {
    ...
    retry: 'Retry', create: 'Create and save', save: 'Save new version', unsaved: 'Unsaved changes', savedLabel: 'Database version', digest: 'Stable digest', noLive: 'Save and preview only · no publishing', schedule: 'Schedule contract', addSchedule: 'Build schedule preview', scheduleHint: 'IANA time zone; DST gaps fail closed and folds require an explicit choice.', scheduleSaveFirst: 'Save content edits first, then bind the schedule to that exact revision.', once: 'One-time', recurring: 'Constrained recurring', brandMatrix: 'Brand and market matrix', claimEvidence: 'Claim / Evidence', content: 'Editable content', preview: 'Native-like preview', constraints: 'Public-safe constraints', noSignals: 'No real interaction signals exist. M1 does not collect comments, replies, DMs, or platform data.', reviewHint: 'This view shows versions and risk only. M1 creates no OwnerDecision, ActionGrant, or Receipt.'
  }
} as const;
