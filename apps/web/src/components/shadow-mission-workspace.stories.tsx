...
export const LiveWaitingForCoordinatorRunner: Story = {args: {fixtureState: 'waiting-runtime'}};
...
export const ChineseLiveWaiting390px: Story = {args: {locale: 'zh-CN', fixtureState: 'waiting-runtime'}, parameters: {viewport: {defaultViewport: 'mobile1'}}};
