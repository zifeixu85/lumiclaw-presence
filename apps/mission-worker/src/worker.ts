import {
  ...
  type GoalPlanRepository,type PersistentRuntimeRepository,type RuntimeBinding,type RuntimeLease,type RuntimeSubmissionEnvelope
...
export class PersistentMissionWorker{
  ...
  public async tick():Promise<'IDLE'|'RECOVERED_MATERIALIZATION'|'RECOVERED_SUBMISSION'|'CONFIRMED_COMPLETION'|'ACCEPTED'|'BLOCKED'> {
