...
The specification and lifecycle artifacts agree on one bounded, non-executing slice. The first set is exactly US, JP and DE. Customer material is represented only by synthetic Organization fixtures. Public knowledge is sourced, versioned and scoped. A deterministic resolver and role-specific context views are the implementation core; Storybook is evidence, not a second product truth.
